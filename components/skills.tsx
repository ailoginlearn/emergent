...
type Category = {
  ...
  accent: string // tailwind bg tint class for the icon tile
  ring: string // gradient ring on hover
  skills: Skill[]
}
  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-0 top-1/3 h-[400px] w-[400px] rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute right-0 top-1/4 h-[400px] w-[400px] rounded-full bg-fuchsia-500/10 blur-3xl" />
        <div
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <div className="relative flex h-full flex-col rounded-2xl border border-border/60 bg-background/60 p-6 backdrop-blur transition-colors duration-500 group-hover:border-primary/40">
                {/* Icon tile */}
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-xl ${cat.accent}`}
                >
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {[...marqueeTech, ...marqueeTech].map((tech, i) => (
                <div
                  key={`${tech.label}-${i}`}
                  className="inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-border/60 bg-background/60 px-4 py-2 text-sm font-medium text-muted-foreground backdrop-blur transition-colors hover:border-primary/40 hover:text-foreground"
                >
